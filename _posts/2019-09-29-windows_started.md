...
Install [wget][wget] which is also available as [cygwin][cygwin] package, openjdk (11.0.3+), and some version of ruby-2.4+ preferably jruby-9.2.9.0+. If you encounter linkage problems it might be worth looking the [AdoptOpenJDK][adopt] distribution.

...
//    }
  ...
  static public void selectFolder(final String prompt,
    ...
    /**
     * @param output
     * @return I want to print lines to a file. Why am I always explaining
...
//  }
   ...
   * @param mode either OPEN, CHORD, or PIE
     ...
     * careful not to assign it to an int value.The red() function is easy to
     * use and undestand, but is slower than another technique. To achieve the
     * same results when working in <b>colorMode(RGB, 255)</b>, but with greater
     * speed, use the &gt;&gt; (right shift) operator with a bit mask. For
     * example, the following two lines of code are equivalent:<br

...
public class PerlinNoise {
    ...
    private static final double PERLIN_MIN_AMPLITUDE = 0.001f;

    protected int perlin_octaves = 4; // default to medium smooth

    protected double perlin_amp_falloff = 0.5f; // 50% reduction/octave

    // [toxi 031112]
    // new vars needed due to recent change of cos table in PGraphics
    protected int perlin_TWOPI, perlin_PI;

    protected double[] perlin_cosTable;

    protected double perlin[];
    ...
    private double noise_fsc(double i) {
        ...
        return 0.5 * (1.0 - perlin_cosTable[(int) ((i + 0.5) * perlin_PI)
                % perlin_TWOPI]);
    }

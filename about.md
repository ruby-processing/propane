...
[propane][propane] is a ruby implementation of [processing][processing]. Create processing sketches in ruby using regular ruby-2.6 syntax, and use the magic [JRuby][jruby] to run them. You can use both rubygems and and regular processing libraries in your sketches. Run them with jruby.

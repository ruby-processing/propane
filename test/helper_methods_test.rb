...
class HelperMethodsTest < Minitest::Test
  ...
  def test_dist
    ...
    bx = 1.0
    by = 1.0
    assert_in_epsilon(dist(ax, ay, bx, by), Math.sqrt(2), 0.0001, msg = '2D distance')
    by = 0.0
    assert_in_epsilon(dist(ax, ay, bx, by), 1.0, 0.0001, msg = 'when y dimension is zero')
    ax = 0
    ay = 0
    bx = 0.0
    by = 0.0
    assert_in_epsilon(dist(ax, ay, bx, by), 0.0, 0.0001, msg = 'when x and y dimension are zero')
    ax = 1
    ay = 1
    bx = -2.0
    by = -3.0
    assert_in_epsilon(dist(ax, ay, bx, by), 5.0, 0.0001, msg = 'classic triangle dimensions')
    ax = -1
    ay = -1
    bx = 100
    by = 2.0
    cx = 3.0
    cy = 100
    assert_in_epsilon(dist(ax, ay, bx, by, cx, cy), 5.0, 0.0001, msg = 'classic triangle dimensions')
    ax = 0
    ay = 0
    bx = -1.0
    by = -1.0
    cx = 0
    cy = 0
    assert_in_epsilon(dist(ax, ay, bx, by, cx, cy), Math.sqrt(2), 0.0001, msg = '2D distance')
    ax = 0
    ay = 0
    bx = 0.0
    by = 0.0
    ...
    cx = 0
    cy = 0
    assert_in_epsilon(dist(ax, ay, bx, by, cx, cy), 1.0, 0.0001, msg = 'when x and z dimension are zero')
  end
